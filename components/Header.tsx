...
function Header({}: Props) {
  ...
  return (
    <div className="max-w-6xl mx-auto p-2">
      ...
      <hr className="mt-2" />
      <section className="flex intems-center space-x-2 py-5">
        <div className="h-6 w-16 sm:w-28 md:w-44 cursor-pointer flext-shrink-0">
          <Link href="/">
            <Image
        ...
        <div
          className="flex items-center space-x-2 px-2 md:px-5 py-2
        ...
        <Link href="/create">
          <button
            className="border-2 border-blue-600 px-5 md:px-10 py-2 text-blue-600
      ...
      whitespace-nowrap justify-center p-6"
      >
        ...
        <p className="link hidden lg:inline">Collectables and Art</p>
